...
import by.halatsevich.storage.controller.command.impl.RemoveBooksByNameCommand;
...
public class RemoveBooksByNameCommandTest {
    Command command;
    ...
    public void setUp() {
        IdGenerator.setId(1);
        command = new RemoveBooksByNameCommand();
        bookParameters.put("name", "Name1");
