...
import by.halatsevich.storage.controller.command.impl.SortByTagCommand;
...
public class SortByTagCommandTest {
    ...
    public void setUp() {
        ...
        bookParameters.put("sorting tag", "price");
        bookParameters.put("ascend", "false");
    ...
    public void testExecuteFailure() {
        bookParameters.put("sorting tag", "rtyui");
